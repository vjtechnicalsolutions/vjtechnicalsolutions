...
export const EXTRA_SOLUTIONS: Record<string, ExtraSolution> = {
  cctv: {
    ...
    eyebrow: "MARINE CCTV",
    intro: "Eyes at sea, around the clock. We design and install marinised IP camera systems with onboard recording and AI-assisted analytics — so blind spots, mooring lines and engine spaces are watched even when the crew isn't.",
    features: ["IP67 marinised cameras, 4–64 channels","Onboard NVR with 30–90 day storage","AI analytics: MOB zones and intrusion alerts","Low-bandwidth remote viewing for shore teams","Night-vision and thermal options"],
    benefits: ["Blind-spot coverage across deck and engine spaces","Recorded evidence for incidents and insurance","Shore-side situational awareness for fleet managers","Survey and vetting inspection support"],
    useCases: [
  ...
  "crew-wifi": {
    ...
    intro: "Happy crew, retained crew. Our managed crew Wi-Fi gives every seafarer fair, reliable internet access over whichever bearer is active — with quotas and policies that protect operational traffic automatically.",
    features: ["Captive portal with vouchers / PINs","Per-crew bandwidth and time quotas","Fair-use QoS that never touches operations","Works over LEO, VSAT or LTE — automatic","Per-vessel usage reporting to shore"],
    benefits: ["Morale and retention measurably improve","Zero admin burden for officers","Operational bandwidth always protected","Clear usage accountability per crew member"],
    useCases: [
  ...
  lte: {
    ...
    eyebrow: "LTE HYBRID",
    intro: "Stop burning satellite airtime in port. Our LTE hybrid setups automatically offload traffic to 4G/LTE whenever shore networks are in reach — cutting airtime spend while giving the crew their fastest link of the voyage.",
    features: ["Automatic shore-side LTE offload","Multi-carrier roaming SIMs","SD-WAN integrated — no manual switching","Cuts satellite airtime spend in port","Marine LTE router + high-gain antennas"],
    benefits: ["Lower monthly airtime bills","Fastest speeds of the voyage, in port","Seamless, session-persistent switching","Simple, rugged hardware"],
    useCases: [
  ...
  spares: {
    ...
    image: "/vjtechnicalsolutions/assets/maritime-service-scene.png",
    eyebrow: "SPARE PARTS",
    intro: "Downtime is the expensive part — not the component. We source and ship genuine spares for VSAT and LEO terminals, network gear and RF hardware, delivered to your vessel's next port before she berths.",
    features: ["Antennas — VSAT domes, flat panels, L-band terminals","RF cables, connectors, glands & antenna mounts","Routers & switches — MikroTik RB5009, Cisco Catalyst","Wi-Fi access points, SFP modules & network accessories","Dispatch to 40+ ports within 24–72 hours"],
    benefits: ["Less downtime — the part is waiting at the next port","Right part first time, matched to your serials","We handle logistics, customs paperwork included","Repair-not-replace saves real money"],
    useCases: [
